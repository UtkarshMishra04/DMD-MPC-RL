...
from envs.environments.dexterous_gym.core.two_hands_env import TwoHandsEnv

dir_path = os.path.dirname(os.path.realpath(__file__))
MODEL_XML = dir_path+"/hand/block_handover.xml"
DEFAULT_RANGE_1 = np.array([[0.96, 1.04], [0.81, 0.89], [0.2, 0.26]])
DEFAULT_RANGE_2 = np.array([[0.96, 1.04], [0.60, 0.68], [0.2, 0.26]])

class BlockHandOver(TwoHandsEnv, utils.EzPickle):
